...
9. **009-single-server-with-descriptions.patch** - Updates to single server (feralisme.fr) with descriptions and pre-selection
10. **010-feral-theme-onboarding.patch** - Customizes onboarding screen with Times New Roman font for "Be Feral"
11. **011-feral-forest-theme.patch** - Adds complete Feral forest theme with dark atmosphere and gradients
