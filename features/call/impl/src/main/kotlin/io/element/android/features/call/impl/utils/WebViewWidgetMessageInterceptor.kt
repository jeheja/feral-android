 ...
 */
// Modified by Feral: the injected console override comes from the Feral-owned
// FeralCallWebViewConsoleShim (cycle-safe; upstream's bare JSON.stringify threw inside
// Element Call 0.24.0 and killed every call — element-hq/element-call#4164).
    ...
    init {
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun onPageStarted(view: WebView, url: String, favicon: Bitmap?) {
                ...
                // Modified by Feral: cycle-safe script, see FeralCallWebViewConsoleShim.
                view.evaluateJavascript(FeralCallWebViewConsoleShim.SCRIPT, null)
